...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.num_fpn_levels = 3 #int(np.log2(stride) - np.log2(self.common_stride)) # 伊藤が勝手に書き換えた
    ...
    @classmethod
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):# NOTE:糞実装3か所あり
        ret = {}
        ret["input_shape"] = {
            k: v for k, v in input_shape.items() if k in input_shape
        }
